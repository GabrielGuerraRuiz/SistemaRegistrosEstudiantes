 ...
 **Compilar**:
   - Usa el comando `javac` para compilar. Ejemplo:
     ```
 ...
 **Ejecutar**:
   - Una vez compilado, ejecuta el archivo `.class` con el comando `java` (sin la extensión `.class`):
     ```
     java SistemaRegistroEstudiante
     ```
 ### Ejemplo Básico de Código Java
